...
export class SR5ActiveEffectConfig extends foundry.applications.sheets.ActiveEffectConfig<SR5ActiveEffectSheetData> {
    ...
    static override PARTS = {
        ...
        changes: {template: 'systems/sr4/dist/templates/effect/active-effect-changes.hbs', scrollable: ["ol[data-changes]"]},
        // override the details tab so we can include our extra settings
        details: {template: 'systems/sr4/dist/templates/effect/active-effect-details.hbs', scrollable: [""]},
        applyTo: {template: 'systems/sr4/dist/templates/effect/active-effect-apply-to.hbs'},
        help: {template: 'systems/sr4/dist/templates/effect/active-effect-help.hbs'},
    }
