...
export const preloadHandlebarsTemplates = async () => {
    ...
    const templateBase = (path: string) => {
        return `systems/sr4/dist/templates/v2/${path}.hbs`
    }
    ...
    const templatePaths = [
        ...
        'systems/sr4/dist/templates/rolls/parts/parts-list.hbs',
        'systems/sr4/dist/templates/rolls/parts/Damage.hbs',

        // to wrap the bodies of tabs
        'systems/sr4/dist/templates/common/TabWrapper.hbs',
        'systems/sr4/dist/templates/common/ValueInput.hbs',

        // Useful wrapper and implemented components
        'systems/sr4/dist/templates/common/ValueMaxAttribute.hbs',
        'systems/sr4/dist/templates/common/Attribute.hbs',
        'systems/sr4/dist/templates/common/ValueModifiers.hbs',

        // useful select template for the common pattern
        'systems/sr4/dist/templates/common/Select.hbs',

        // to create the condition monitors and edge counter
        'systems/sr4/dist/templates/common/HorizontalCellInput.hbs',

        // looks like a ListHeader
        'systems/sr4/dist/templates/common/HeaderBlock.hbs',

        'systems/sr4/dist/templates/common/NameLineBlock.hbs',

        // list components
        'systems/sr4/dist/templates/common/List/ListItem.hbs',
        'systems/sr4/dist/templates/common/List/ListEntityItem.hbs',
        'systems/sr4/dist/templates/common/List/ListHeader.hbs',

        // dialogs
        'systems/sr4/dist/templates/apps/dialogs/damage-application.hbs',
        'systems/sr4/dist/templates/apps/dialogs/parts/success-test-common.hbs',
        'systems/sr4/dist/templates/apps/dialogs/parts/success-test-documents.hbs',
        'systems/sr4/dist/templates/apps/dialogs/parts/attack-range-dialog-fragment.hbs',

        // Test chat messages and their parts
        'systems/sr4/dist/templates/rolls/success-test-message.hbs',
        'systems/sr4/dist/templates/rolls/parts/rolled-dice.hbs',

        // Application - Compendium Browser
        'systems/sr4/dist/templates/apps/compendium-browser/settings-folder.hbs',

        // Application - Situational Modifiers
        'systems/sr4/dist/templates/apps/partials/modifiers-physical.hbs'
    ];
