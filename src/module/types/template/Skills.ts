...
export const Skills = () => new FixedTypeObjectField(
    new ModifiableField(SkillField()),
    {
        ...
        exotic_melee: skill({ attribute: "agility", canDefault: false, id: "exotic_melee" }),
        exotic_range: skill({ attribute: "agility", canDefault: false, id: "exotic_range" }),
        ...
        pilot_exotic_vehicle: skill({ attribute: "reaction", canDefault: false, id: "pilot_exotic_vehicle" }),
